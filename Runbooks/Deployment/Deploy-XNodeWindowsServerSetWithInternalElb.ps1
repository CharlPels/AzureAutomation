<#
    .DESCRIPTION
        Deployment of a multible Windows Servers behind Internal ELB 
...
param(
    ...
    [Parameter(Mandatory=$False)]
    [String] $ServersStorageType = "getcustomerdefault",
...
if ($numberOfInstances -le 2) {write-host "You need at least 2 servers for deployment and you typed: $numberOfInstances"}
...
if ($ServersStorageType  -eq "getcustomerdefault") {$ServersStorageType = Get-AutomationVariable -Name CustomerDefaultServerStorageType}
...
$Azureparameters = @{}
$Azureparameters.Add("ServersStorageType", $ServersStorageType)
...
$Azureparameters.Add("loadBalancerName", $loadBalancerName)
$Azureparameters.Add("loadBalancerIP", $loadBalancerIP)
...
$TemplateUri  = $baseuri + "VirtualServers/" + "GenericxNodePairWithInternalLoadBalancer-storageaccount.json" + $SAScontainertoken
